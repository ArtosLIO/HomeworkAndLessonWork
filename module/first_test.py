...
my_string = """Function receives a long string with many words"""
my_words = ['nunction', 'receives', 'an', 'strings', 'a', 'aa']
my_string2 = (
...
#print(spam(1))
#print(my_sum([5, 10, 4, 9]))
# print(shortener(my_string2[1]))
#print(compare_ends(my_words))
